...
/**
 * SimpleDirectedLabeledGraph.<br><br>
 * 
 ...
 * @version 1.0
 */
public class SimpleLabeledGraph<V,E> extends AbstractGraph<V> implements LabeledGraph<V,E> {

    private Set<Edge> edges;
    
    public SimpleLabeledGraph() {
        super();
        edges = new LinkedHashSet<Edge>();
    }
    
    public SimpleLabeledGraph(Set<V> n) {
        super(n);
        edges = new LinkedHashSet<Edge>();
    }
    
    public SimpleLabeledGraph(Set<V> n, Set<Pair<V,V>> e) {
        super(n);
        edges = new LinkedHashSet<Edge>();
        for (Pair<V,V> edge : e) {
    ...
    private class Edge {
        ...
        public boolean equals(Object o) {
            if (o instanceof SimpleLabeledGraph.Edge) {
                Edge e = (Edge)o;
    ...
    /* (non-Javadoc)
     * @see structures.graph.LabeledGraph#containsEdge(V, E, V)
     */
    ...
    /* (non-Javadoc)
     * @see structures.graph.LabeledGraph#containsEdge(structures.Triple)
     */
    ...
    /* (non-Javadoc)
     * @see structures.graph.LabeledGraph#containsAllEdges(java.util.Collection)
     */
